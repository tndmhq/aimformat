...
|---|---|---|---|---|
| 2026-07-07 19:21 | review | [v01-deep-self-review](2026-07-07_1921_review_v01-deep-self-review.md) | active | Post-ship adversarial review of the v0.1 toolkit (own pass + three independent review agents): findings, severities, and the fixes applied. |
