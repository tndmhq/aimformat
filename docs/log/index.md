...
|---|---|---|---|---|
| 2026-07-10 12:45 | plan | [fixed-layout-pages](2026-07-10_1245_plan_fixed-layout-pages.md) | active | Canvas-as-points convention; per-canvas PDF pages; DOCX linearizes slides + honors image width |
