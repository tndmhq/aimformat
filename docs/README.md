...
Because this repo is **public**, the memory carries two extra rules
(from `AGENTS.md` → Governance): `knowledge/` is maintainer-authoritative
(changes reviewed like code), and everything in here is **technical** — no
business or strategy reasoning.
...
substantial reviews/reports. **Kept deliberately light** — this is a
