...
doc.verify()                    # [] on success, or precise chain-break findings
...
Every document you just created opens with the *agent note* (spec §2.5), a
head comment that tells any LLM opening the file what it is and how to
...
- [`examples/`](../../examples): worked prose, deck, and booklet documents,
  generated by `scripts/gen_examples.py`.
